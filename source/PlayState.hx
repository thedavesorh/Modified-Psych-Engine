...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		timeTxt.setFormat(Paths.font("comic.ttf"), 32, FlxColor.PINK, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.YELLOW);
		...
		timeBar = new FlxBar(timeBarBG.x + 9999, timeBarBG.y + 9999, LEFT_TO_RIGHT, Std.int(timeBarBG.width - 8), Std.int(timeBarBG.height - 8), this,
			'songPercent', 0, 1);
		...
		scoreTxt.setFormat(Paths.font("comic.ttf"), 20, FlxColor.BLUE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.RED);
		...
		botplayTxt.setFormat(Paths.font("comic.ttf"), 32, FlxColor.GREEN, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.WHITE);
